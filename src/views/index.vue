    ...
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        ...
        <p>
          ...
          如此有了若依管理系统，她可以用于所有的Web应用程序，如网站管理后台，网站会员中心，CMS，CRM，OA等等，当然，您也可以对她进行深度定制，
          以做出更强系统。所有前端后台代码封装过后十分精简易上手，出错概率低。同时支持移动客户端访问。系统会陆续更新一些实用功能。
        </p>
        <p>
      ...
      <el-col :xs="24" :sm="24" :md="12" :lg="12">
        <el-card class="update-log">
          ...
          <div class="body">
            ...
            <p>
              <i class="el-icon-user-solid"></i> 可用QQ群：
              <a class="link-type el-link"
